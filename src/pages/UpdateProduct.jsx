...
const UpdateProduct = () => {
    ...
    const { _id, image, name, brand, type, desc, rating, price } = product;
    // console.log(product)
    ...
    const handleUpdateProduct = event => {
        ...
        const updatedProduct = { name, brand, image, type, price, rating, desc }
        // console.log(updatedProduct);

        // update products to the server
        fetch(`https://blushify-server-n4u453k6t-sumiya-islams-projects.vercel.app/products/${_id}`,{
            method: 'PUT',
            headers: {
       ...
       <div className="px-8 md:px-12 lg:px-60 py-20">
        <div className="border-[1.5px] rounded-xl px-8 lg:px-12 py-14">
          ...
          <form onSubmit={handleUpdateProduct}>
            ...
            <div className="my-5">
              <button className="bg-[#F44545] w-full font-display text-white p-3 rounded-md text-base font-medium">Update Product</button>
            </div>
          </form>
        </div>
      </div>
